...
#### 💡 Insights
- Lazada -84.8% First Time Buyer, 15.2% Repeat Customers
- Shopee - 84.9% First Time Buyer, 15.1% Repeat Customers
- Overall - 84.9% First Time Buyer, 15.1% Repeat Customers

#### 🥱 So What?
1. The data shows that majority of customer (85%) are first-time buyers across both platforms. This highlights a strong acquisition trend but also indicates a challenge in driving repeat purchases.
